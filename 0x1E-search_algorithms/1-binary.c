 ...
 *
 * Return: First index where value is located | -1
 */
...
/**
 * binary_search_helper - The recursive binary search algorithm.
 * @array: The array to be searched
 * @value: The value to be searched
 * @left_idx: The leftmost index of the subarray
 * @right_idx: The rightmost index of the subarray
 *
 * Return: The index of the value searched if found | -1
 */
